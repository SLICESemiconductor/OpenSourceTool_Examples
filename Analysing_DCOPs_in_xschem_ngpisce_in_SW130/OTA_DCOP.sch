...
sim_type=tran
autoload=0}
T {ctrl + left click to back annotate DCOPs} 470 230 0 0 0.4 0.4 {}
...
C {devices/ngspice_get_value.sym} 460 -510 0 0 {name=r6 
node=@m.$\{path\}xm6.msky130_fd_pr__pfet_01v8[gds]
descr="gds="}
C {devices/ngspice_get_value.sym} 540 -510 0 0 {name=r7 
node=v(@m.$\{path\}xm6.msky130_fd_pr__pfet_01v8[vdsat])
descr="vdsat="}
C {devices/ngspice_get_expr.sym} 300 -410 0 0 {name=r18 
...
C {devices/launcher.sym} 530 200 0 0 {name=h1
descr=Backannotate
...
C {devices/ngspice_get_value.sym} 460 -560 0 0 {name=r1 
node=@m.$\{path\}xm6.msky130_fd_pr__pfet_01v8[gm]
xnode="[to_eng \{@m.$\{path\}xm6.msky130_fd_pr__pfet_01v8[gm]\}]"
descr="gm="}
C {devices/ngspice_get_value.sym} 540 -560 0 0 {name=r2 
node=v(@m.$\{path\}xm6.msky130_fd_pr__pfet_01v8[vth])
descr="vth="}
C {devices/ngspice_get_value.sym} 600 -560 0 0 {name=r3 
node=i(@m.$\{path\}xm6.msky130_fd_pr__pfet_01v8[id])
descr="Id="}
C {devices/ngspice_get_value.sym} 600 -510 0 0 {name=r4 
node=v(@m.$\{path\}xm6.msky130_fd_pr__pfet_01v8[vgs])
descr="vgs="}
C {devices/ngspice_get_value.sym} 460 -470 0 0 {name=r5 
node=v(@m.$\{path\}xm6.msky130_fd_pr__pfet_01v8[vds])
descr="vds="}
C {devices/ngspice_get_expr.sym} 240 -410 0 0 {name=r8 
...
descr="Vov="}
C {devices/ngspice_get_expr.sym} 170 -500 0 0 {name=r9 node="[to_eng [ngspice::get_node \{@m.$\{path\}xm6.msky130_fd_pr__pfet_01v8[gm]\}]]"
descr = "gm"}
C {devices/ngspice_get_expr.sym} 170 -450 0 0 {name=r10 node="[to_eng [ngspice::get_node \{@m.$\{path\}xm6.msky130_fd_pr__pfet_01v8[gds]\}]]"
descr = "gds"}
C {devices/ngspice_get_expr.sym} 240 -500 0 0 {name=r11 node="[to_eng [ngspice::get_node \{v(@m.$\{path\}xm6.msky130_fd_pr__pfet_01v8[vth])\}]]"
descr = "vth"}
C {devices/ngspice_get_expr.sym} 300 -500 0 0 {name=r12 node="[to_eng [ngspice::get_node \{i(@m.$\{path\}xm6.msky130_fd_pr__pfet_01v8[id])\}]]"
descr = "id"}
C {devices/ngspice_get_expr.sym} 240 -460 0 0 {name=r13 node="[to_eng [ngspice::get_node \{v(@m.$\{path\}xm6.msky130_fd_pr__pfet_01v8[vdsat])\}]]"
descr = "vdsat"}
C {devices/ngspice_get_expr.sym} 300 -460 0 0 {name=r14 node="[to_eng [ngspice::get_node \{v(@m.$\{path\}xm6.msky130_fd_pr__pfet_01v8[vgs])\}]]"
descr = "vgs"}
C {devices/ngspice_get_expr.sym} 170 -410 0 0 {name=r15 node="[to_eng [ngspice::get_node \{v(@m.$\{path\}xm6.msky130_fd_pr__pfet_01v8[vds])\}]]"
descr = "vds"}
