...
N 700 -300 740 -300 {
lab=vdda}
N 640 -300 660 -300 {lab=vdda}
N 640 -360 640 -300 {lab=vdda}
N 640 -360 700 -360 {lab=vdda}
N 640 -300 640 -260 {lab=vdda}
N 640 -260 700 -260 {lab=vdda}
N 700 -270 700 -260 {lab=vdda}
N 700 -360 740 -360 {lab=vdda}
N 740 -360 740 -300 {lab=vdda}
N 520 -360 520 -330 {
lab=vdda}
N 520 -300 560 -300 {
lab=vdda}
N 460 -300 480 -300 {lab=vdda}
N 460 -360 460 -300 {lab=vdda}
N 460 -360 520 -360 {lab=vdda}
N 460 -300 460 -260 {lab=vdda}
N 460 -260 520 -260 {lab=vdda}
N 520 -270 520 -260 {lab=vdda}
N 520 -360 560 -360 {lab=vdda}
N 560 -360 560 -300 {lab=vdda}
...
C {sg13g2_pr/sg13_lv_nmos.sym} 280 180 0 0 {name=M14
l=1u
w=2u
ng=2
m=4
...
C {devices/lab_wire.sym} 280 220 0 0 {name=p22 sig_type=std_logic lab=vssa}
C {sg13g2_pr/sg13_lv_nmos.sym} 280 -60 0 1 {name=M16
l=0.5u
w=8u
ng=8
m=4
...
C {sg13g2_pr/sg13_lv_pmos.sym} 240 -340 0 0 {name=M36
l=2u
w=4u
ng=2
m=2
...
C {devices/lab_wire.sym} 740 -300 0 0 {name=p41 sig_type=std_logic lab=vdda}
C {sg13g2_pr/sg13_lv_pmos.sym} 680 -300 0 0 {name=M40
l=1u
w=2u
ng=2
m=4
...
C {devices/lab_wire.sym} 560 -300 0 0 {name=p9 sig_type=std_logic lab=vdda}
C {sg13g2_pr/sg13_lv_pmos.sym} 500 -300 0 0 {name=M4
l=2u
w=8u
ng=2
m=2
...
C {devices/lab_wire.sym} 440 220 0 0 {name=p15 sig_type=std_logic lab=vssa}
