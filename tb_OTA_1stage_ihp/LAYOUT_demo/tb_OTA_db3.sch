...
SCH; vout %0 $netlist_dir/tb_OTA_tran_sch.raw
PEX_RC; vout x%0 $netlist_dir/tb_OTA_tran_pex_rc.raw
PEX_C; vout x%0 $netlist_dir/tb_OTA_tran_pex_c.raw
PEX_R; vout x%0 $netlist_dir/tb_OTA_tran_pex_r.raw
PEX_FE; vout x%0 $netlist_dir/tb_OTA_tran_pex_fe.raw
...
PEX_RC; ph(av) x%0 $netlist_dir/tb_OTA_1stage_ac2_pex_rc.raw
PEX_C; ph(av) x%0 $netlist_dir/tb_OTA_1stage_ac2_pex_c.raw
PEX_R; ph(av) x%0 $netlist_dir/tb_OTA_1stage_ac2_pex_r.raw
PEX_FE; ph(av) x%0 $netlist_dir/tb_OTA_1stage_ac2_pex_fe.raw
...
logx=1
logy=0
rawfile=$netlist_dir/tb_OTA_1stage_ac1.raw
autoload=1
x2=11
linewidth_mult=4
sim_type=ac
...
PEX_RC; av db20() x%0 $netlist_dir/tb_OTA_1stage_ac2_pex_rc.raw
PEX_C; av db20() x%0 $netlist_dir/tb_OTA_1stage_ac2_pex_c.raw
PEX_R; av db20() x%0 $netlist_dir/tb_OTA_1stage_ac2_pex_r.raw
PEX_FE; av db20() x%0 $netlist_dir/tb_OTA_1stage_ac2_pex_fe.raw
...
# FE extracted netlist (no backend)
xschematic=OTA_final
...
# RC extracted netlist (no vdda or vssa) 
xschematic=OTA_final
...
# R extracted netlist (no vdda or vssa) 
xschematic=OTA_final
