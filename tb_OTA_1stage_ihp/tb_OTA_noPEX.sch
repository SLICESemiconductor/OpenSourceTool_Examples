...
Cesd_op; vout %0 $netlist_dir/tb_OTA_tran_Cesd_op.raw
SCH_750f; vout %0 $netlist_dir/tb_OTA_tran_sch_750f.raw"
color="10 12 4 7"
dataset=-1
unitx=1
logx=0
...
color="11 7 10 12 4 7"
node="\\" -45\\"
\\" -90\\"
\\" -180\\"

SCH; ph(av) %0 $netlist_dir/tb_OTA_1stage_ac2_sch.raw
Cesd_op; ph(av) %0 $netlist_dir/tb_OTA_1stage_ac2_Cesd_op.raw
SCH_750f; ph(av) %0 $netlist_dir/tb_OTA_1stage_ac2_sch_750f.raw"
y1=-217.22606
y2=70.77394
autoload=1
x1=3.571045
...
Cesd_op; av db20() %0 $netlist_dir/tb_OTA_1stage_ac2_Cesd_op.raw
SCH_750f; av db20() %0 $netlist_dir/tb_OTA_1stage_ac2_sch_750f.raw"
}
...
B 2 700 80 1500 480 {flags=graph
y1=0.62810383
y2=2.3058254
ypos1=0
ypos2=2
...
B 2 1520 80 2320 480 {flags=graph
y1=-0.00078
y2=34
ypos1=0
ypos2=2
...
xlabmag=1.0
ylabmag=1.0
node="nesd; i(vstep) -1 * %0 $netlist_dir/tb_OTA_tran_sch_nesd2.raw
wesd; i(vstep) -1 * %0 $netlist_dir/tb_OTA_tran_sch_wesd2.raw"
color="7 11"
dataset=-1
unitx=1
logx=0
