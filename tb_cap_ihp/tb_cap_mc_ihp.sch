...
.lib /home/slice/pdk/iHP/IHP-Open-PDK/ihp-sg13g2/libs.tech/ngspice/models/cornerCAP.lib cap_typ_mismatch
...
.temp 27
  ...
  ** 1. AC ANALYSIS **   
  ...
  echo \\"$&cmeas\\"
  echo \\"$&cmeas\\" >> cap_measures_typ_mc.txt
  
  remzerovec
  set filetype=binary
  ** first write deletes existing file
  write tb_cap_ihp_mc.raw
...
C {sg13g2_pr/cap_cmim.sym} 80 430 0 0 {name=C1
model=cap_cmim
w=50.0e-6
l=10.0e-6
m=1
